...
import { getActivePlan, getWindowsPlans, setWindowsPlan } from './powercfg/Powercfg';

// eslint-disable-next-line @typescript-eslint/no-unused-vars
const LOGGER = getLogger('WindowsPlanListeners');

export const buildWindowsPlanListeners = (ipc: IpcMain, window: BrowserWindow) => {
	...
	ipc.on('setWindowsPlan', async (_event, datas: { name: string; guid: string }) => {
